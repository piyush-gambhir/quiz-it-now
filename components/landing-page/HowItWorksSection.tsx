        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p>Paste text, upload a PDF, or provide a link to video or audio content.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">AI Processes Content</h3>
              <p>Our advanced AI analyzes the content and generates relevant questions.</p>
            </div>
            <div className="text-center">
              ...
              <p>Receive a set of questions based on your content, ready to use or customize.</p>
            </div>
          </div>
        </div>
      </section>
