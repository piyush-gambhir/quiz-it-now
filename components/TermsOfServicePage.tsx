      ...
      <Card className="mx-auto shadow-lg border border-gray-200 dark:border-gray-700">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p className="text-lg">
              Welcome to Quiz Master. By using our website and services, you
          ...
          <section className="mb-8">
            ...
            <p className="text-lg">
              All content and materials available on Quiz Master, including but
              not limited to text, graphics, website name, code, images and
              logos are the intellectual property of Quiz Master and are
          ...
          <section className="mb-8">
            ...
            <p className="text-lg">
              Quiz Master shall not be liable for any indirect, incidental,
