            ...
            <Card className="mx-auto shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <CardContent className="prose dark:prose-invert max-w-none">
                    <section className="mb-8">
                        ...
                        <p className="text-lg">
                            This Cookie Policy explains how Quiz Master uses
                            cookies and similar technologies to recognize you
                            when you visit our website. It explains what these
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-lg">
                            ...
                            reject cookies. You can set or amend your web
                            browser controls to accept or refuse cookies. If you
